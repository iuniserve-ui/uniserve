...
const Hero = () => {
  return (
    <div>
      <section className="relative min-h-screen bg-linear-to-r from-[#0a2540] to-[#1c3d5a] text-white flex items-center px-6 md:px-16 pt-12 md:pt-20 pb-16">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full gap-12 md:gap-20">
          ...
          <div className="max-w-xl text-center md:text-left">
            ...
            {/* Contact Row */}
            <div className="flex items-center justify-center md:justify-start gap-3 text-[13px] text-gray-300 mb-4">

              <a
                href="tel:+918867456566"
                className="flex items-center gap-2 hover:text-yellow-400 transition whitespace-nowrap"
              >
                <Phone size={15} />
